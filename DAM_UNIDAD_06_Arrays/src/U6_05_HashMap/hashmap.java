...
//Vamos a crear una aplicación a través de la que vamos a realizar todas
//las operaciones posibles con los HashMap
    // Declaración 
    // Altas 
    // Recorrido 
    // Búsquedas 
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n\n********* Foreach: Forma alternativa para recorrer los Map mostrando laClave y el valor:*********");
