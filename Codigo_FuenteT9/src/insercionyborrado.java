...
public class InsercionYBorrado {
    ...
    public static void consultaEmpleados() throws SQLException {
        ...
        System.out.println("nombre\t\tapellido\t\ttrabajo\t\t\t" + 
    ...
    public static void main(String[] args) {
        try {
            ...
            String inserccion = "INSERT INTO empleados VALUES" + 
            " (10, 'Rodrigo', 'Martos', 'Asesor Financiero', ?, 425.00)";
            PreparedStatement prepStatement =
                conexion.prepareStatement(inserccion);
            ...
            int borrados = sentencia.executeUpdate
                  ("DELETE FROM EMPLEADOS WHERE id_empleado=10");
            System.out.println("------- ------- ------- ");
            System.out.println("Se han borrado "+borrados+" empleado/s.");
            System.out.println("------- ------- ------- ");
